...
SECRET_KEY = '+#rewmdqyxg-e5=@%cu9^e%%8$@9mo1*klfsw-i&l=jldt6@1z'
...
REST_AUTH_SERIALIZERS = {
    'TOKEN_SERIALIZER': 'stock_api.serializers.CustomTokenSerializer'
}

REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'stock_api.serializers.SignupSerializer'
}
